<table class='table table-responsive table-<{$table_type|default:false}>'>
    ...
    <tbody>
        ...
        <tr class='<{cycle values="odd, even"}>'>
            ...
            <td class='center'><a href='<{$wgtestmb_url|default:false}>/articles.php?op=show&amp;art_id=<{$article.id|default:false}>' title='<{$smarty.const._MB_WGTESTMB_ARTICLE_GOTO}>'><{$smarty.const._MB_WGTESTMB_ARTICLE_GOTO}></a></td>
        </tr>
        <{/foreach}>
    </tbody>
    <{/if}>
