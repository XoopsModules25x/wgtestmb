<table class='table table-responsive table-<{$table_type|default:false}>'>
    ...
    <tbody>
        ...
        <tr class='<{cycle values="odd, even"}>'>
            ...
            <td class='center'><{$testtable1.date_text|default:''|escape:'html'}></td>
            <td class='center'><{$testtable1.comments|default:''|escape:'html'}></td>
            <td class='center'><a href='<{$wgtestmb_url|default:''|escape:'htmlattr'}>/testtable1.php?op=show&amp;tt1_id=<{$testtable1.id|default:false}>' title='<{$smarty.const._MB_WGTESTMB_TESTTABLE1_GOTO|escape:"htmlattr"}>'><{$smarty.const._MB_WGTESTMB_TESTTABLE1_GOTO|escape:"htmlattr"}></a></td>
        </tr>
        <{/foreach}>
    </tbody>
    <{/if}>
