<table class='table table-responsive table-<{$table_type|default:false}>'>
    ...
    <tbody>
        ...
        <tr class='<{cycle values="odd, even"}>'>
            ...
            <td class='center'><img src="<{$wgtestmb_upload_url|default:''|escape:'htmlattr'}>/images/articles/<{$article.img|default:''|escape:'html'}>" alt="articles" ></td>
            ...
            <td class='center'><a href='<{$wgtestmb_url|default:''|escape:'htmlattr'}>/articles.php?op=show&amp;art_id=<{$article.id|default:false}>' title='<{$smarty.const._MB_WGTESTMB_ARTICLE_GOTO|escape:"htmlattr"}>'><{$smarty.const._MB_WGTESTMB_ARTICLE_GOTO|escape:"htmlattr"}></a></td>
        </tr>
        <{/foreach}>
    </tbody>
    <{/if}>
